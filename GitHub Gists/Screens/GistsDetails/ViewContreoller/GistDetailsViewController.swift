...
class GistDetailsViewController: UIViewController,
    ...
    func controller(_ controller: NSFetchedResultsController<NSFetchRequestResult>,
        ...
        let fileIndexPath = indexPath != nil ? IndexPath(item: indexPath!.item, section: Sections.files.rawValue) : nil
        let newFileIndexPath = newIndexPath != nil ? IndexPath(item: newIndexPath!.item, section: Sections.files.rawValue) : nil
